...
11. 该结点Y{1:num, 0:num}
12. 该结点X{x1, x2, x3...}
13. 该结点的误差值(熵、基尼指数、均方误差)

"""
class node(object, depth, name, value, operation, data):
    ...
    def __init__(self, name):
        ...
        self.desc = self.name + '' + self.operation + '' + self.value
        self.data = data
        self.y = {}
        self.X = {}
...
clf = DecisionTree(method='C4.5', delta=0.01)
clf.fit(X=X, y=y)
clf.DTree
